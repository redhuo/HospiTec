...
<div class="container register-form">
  <h2 class="text-left">Register binnacle</h2>
  <form class=form-horizontal action=/action_page.php>
    ...
    <div class=form-group>
      <label class="control-label col-sm-2" for=estado>Status:</label>
      <div class=col-sm-6>          
        <input type="text" class=form-control id=estado name=estado>
      </div>
      </div>
      <div class=form-group>
      <label class="control-label col-sm-2" for=ide>Appointment id:</label>
      <div class=col-sm-6>          
