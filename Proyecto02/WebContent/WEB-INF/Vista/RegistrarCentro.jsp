...
<body>
  ...
  <h2 class="text-left">Registrar: Centro de atención</h2>
  <form class=form-horizontal action=/action_page.php>
    <div class=form-group>
      <label class="control-label col-sm-2" for=codigo_centro>Código del centro:</label>
      <div class=col-sm-6>
        <input type="text" class=form-control id=codigo_centro placeholder="Código" name=codigo_centro>
      </div>
    </div>
    <div class=form-group>
      ...
      <div class=col-sm-6>          
        <input type="text" class=form-control id=ubicacion placeholder="Lugar donde está ubicado" name=ubicacion>
      </div>
    </div>
    <div class=form-group>
      <label class="control-label col-sm-2" for=capacidad>Capacidad:</label>
      <div class=col-sm-6>          
        <input type="text" class=form-control id=capacidad placeholder="Capacidad máxima" name=capacidad>
      </div>
    </div>
    <div class=form-group>
