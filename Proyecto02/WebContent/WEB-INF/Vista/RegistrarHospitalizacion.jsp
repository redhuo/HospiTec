...
<body>
	<div class="container register-form">
		...
		<form class=form-horizontal action=/action_page.php>
			...
			<div class=form-group>
				<label class="control-label col-sm-2" for=diainicial>Entry
					day:</label>
				<div class=col-sm-6>
			...
			<div class=form-group>
				<label class="control-label col-sm-2" for=diafinal>Finish
					day:</label>
				<div class=col-sm-6>
			...
			<div class=form-group>
				<label class="control-label col-sm-2" for=idpaciente>Patient
					id:</label>
				<div class=col-sm-6>
			...
			<div class=form-group>
				<label class="control-label col-sm-2" for=codigocentro>Center
					code:</label>
				<div class=col-sm-6>
					<input type="text" class=form-control id=codigocentro
						name=codigocentro>
				</div>
			</div>
			<div class=form-group>
