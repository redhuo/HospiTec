...
<body>
	<div class="container register-form">
		<h2 class="text-left">Register diagnostic treatment</h2>
		<form class=form-horizontal action=/action_page.php>
			<div class=form-group>
				<label class="control-label col-sm-2" for=nombretratamiento>Treatment
					name:</label>
				<div class=col-sm-6>
			...
			<div class=form-group>
				<label class="control-label col-sm-2" for=iddiagnostico>Diagnostic
					id:</label>
				<div class=col-sm-6>
