...
<div class="container register-form">
  <h2 class="text-left">Register Patient telephone</h2>
  <form class=form-horizontal action=/action_page.php>
    <div class=form-group>
      <label class="control-label col-sm-2" for=Codigo>Patient id:</label>
      <div class=col-sm-6>
        <input type="text" class=form-control id=codigo name=codigo>
      </div>
    </div>
    <div class=form-group>
      <label class="control-label col-sm-2" for=telefono>Telephone:</label>
      <div class=col-sm-6>          
