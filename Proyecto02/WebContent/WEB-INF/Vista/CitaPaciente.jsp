...
<div class="container register-form">
  <h2 class="text-left">Register appointment patient</h2>
  <form class=form-horizontal action=/action_page.php>
  <div class=form-group>
      <label class="control-label col-sm-2" for=codigo>Appointment id:</label>
      <div class=col-sm-6>          
        <input type="text" class=form-control id=codigo name=codigo>
      </div>
      </div>
    <div class=form-group>
      <label class="control-label col-sm-2" for=codigopaciente>Patient id:</label>
      <div class=col-sm-6>
        <input type="text" class=form-control id=codigopaciente name=codigopaciente>
      </div>
    </div>
    <div class=form-group>        
