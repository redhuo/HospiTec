...
<div class="container register-form">
  <h2 class="text-left">Registrar: Pacientes</h2>
  <form class=form-horizontal action=/action_page.php>
    ...
    <div class=form-group>
      <label class="control-label col-sm-2" for=tipo_sangre>Tipo de sangre:</label>
      <div class=col-sm-6>          
    ...
    <div class=form-group>
      ...
      <div class=form-group>
      <label class="control-label col-sm-2" for=residencia>Lugar de Residencia:</label>
      <div class=col-sm-6>          
        <input type="text" class=form-control id=residencia placeholder="Recidencia" name=residencia>
      </div>
      </div>
    <div class=form-group>        
